...
class CommentTest(BaseTestCase):
    ...
    def test_add_comment_logged_in(self):
        ...
        response = self.app.post('/movie/1087192', data=dict(
            timestamp='00:01:23',
    ...
    def test_delete_own_comment(self):
        ...
        # Post comment
        self.app.post('/movie/1087192', data=dict(
            timestamp='00:00:05',
            content='Delete me'
        ), follow_redirects=True)
        ...
        # Delete comment
        response = self.app.post(f'/comment/{comment_id}/delete', follow_redirects=True)
        self.assertEqual(response.status_code, 200)
    ...
    def test_cannot_delete_others_comment(self):
        ...
        response = self.app.post(f'/comment/{comment_id}/delete', follow_redirects=True)
        self.assertEqual(response.status_code, 200)
        self.assertIn(b"You don&#39;t have permission to delete", response.data)
